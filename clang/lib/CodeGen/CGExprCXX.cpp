...
static void EnterNewDeleteCleanup(CodeGenFunction &CGF,
  ...
  DominatingValue<RValue>::saved_type SavedNewPtr =
    DominatingValue<RValue>::save(CGF, RValue::get(NewPtr.getPointer(), NewPtr.getAlignment().getQuantity()));
...
llvm::Value *CodeGenFunction::EmitCXXNewExpr(const CXXNewExpr *E) {
  ...
  if (ReservedGlobalPlacement) {
    ...
    if (getTarget().areAllPointersCapabilities() &&
      ...
      allocation = Address(
          setPointerBounds(allocation.getBasePointer(), allocSize,
                           E->getExprLoc(), "new.with.bounds",
    ...
    if (E->getOperatorDelete() &&
      ...
      allocatorArgs.add(RValue::get(allocation.getPointer(), allocation.getAlignment().getQuantity()), arg->getType());
    }
