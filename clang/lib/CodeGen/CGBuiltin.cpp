...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_mempcpy: {
    ...
    if (BuiltinID == Builtin::BImempcpy ||
      ...
      return RValue::get(Builder.CreateInBoundsGEP(
          Dest.getElementType(), Dest.emitRawPointer(*this), SizeVal), Dest.getAlignment().getQuantity());
    else
  ...
  case Builtin::BI__builtin_objc_memmove_collectable: {
    ...
    return RValue::get(DestAddr, *this, DestAddr.getAlignment().getQuantity());
  }
  ...
  case Builtin::BI__builtin___memmove_chk: {
    ...
    Address Src = EmitPointerWithAlignment(E->getArg(1));
    Value *SizeVal = llvm::ConstantInt::get(Builder.getContext(), Size);
    auto *CI = Builder.CreateMemMove(Dest, Src, SizeVal, llvm::PreserveCheriTags::TODO, false);
