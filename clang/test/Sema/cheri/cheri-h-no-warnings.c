...
// RUN: %cheri_cc1 -fsyntax-only -verify -Weverything -Wsystem-headers -Wno-pre-c11-compat %s
// RUN: %cheri_purecap_cc1 -fsyntax-only -verify -Weverything -Wsystem-headers -Wno-pre-c11-compat %s
