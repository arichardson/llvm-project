...
// CHECK: @c = [[$GLOBALS_AS]]global %struct.with_cap_no_attr zeroinitializer, align [[#CAP_SIZE]]
...
with_cap_td b_td;
// CHECK: @a_td = [[$GLOBALS_AS]]global %struct.no_caps_td zeroinitializer, align 4
// CHECK: @b_td = [[$GLOBALS_AS]]global %struct.with_cap_td zeroinitializer, align [[#CAP_SIZE]]
...
with_cap_td2 b_td2;
// CHECK: @a_td2 = [[$GLOBALS_AS]]global %struct.no_caps_td2 zeroinitializer, align 2
// CHECK: @b_td2 = [[$GLOBALS_AS]]global %struct.with_cap_td2 zeroinitializer, align 2
...
// expected-note@-1{{if you are certain that this is correct you can silence the warning by adding __attribute__((annotate("underaligned_capability")))}}
// CHECK: @no_caps_global_align2 = [[$GLOBALS_AS]]global %struct.anon zeroinitializer, align 2
// CHECK: @with_cap_global_align2 = [[$GLOBALS_AS]]global %struct.anon.0 zeroinitializer, align 2
...
// CHECK: @no_caps_global_align3 = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align 4
// CHECK: @with_cap_global_align3 = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @no_caps_global_default_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[#BIG_ALIGN]]
// CHECK: @with_cap_global_default_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[#BIG_ALIGN]]

struct no_caps {
  int i;
} __attribute__((__aligned__));
struct no_caps a;
// CHECK: @a = [[$GLOBALS_AS]]global %struct.no_caps zeroinitializer, align [[#BIG_ALIGN]]

struct with_cap {
  int *__capability i;
} __attribute__((__aligned__));
struct with_cap b;
// CHECK: @b = [[$GLOBALS_AS]]global %struct.with_cap zeroinitializer, align [[#BIG_ALIGN]]
...
// CHECK: @no_caps_global_biggest_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[#BIG_ALIGN]]
// CHECK: @with_cap_global_biggest_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[#BIG_ALIGN]]
