...
// RV64-XCHERI-V8COMPAT: "target-features"="+64bit,+relax,+xcheri,-save-restore,-xcheri-no-v8-compat"
// RV64-XCHERI-NOV8COMPAT: "target-features"="+64bit,+relax,+xcheri,+xcheri-no-v8-compat,-save-restore"
