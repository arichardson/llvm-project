...
// CHECK-NEXT:    call void @llvm.lifetime.start.p200(i64 4096, ptr addrspace(200) [[BYVAL_TEMP]]) #[[ATTR4:[0-9]+]]
...
// CHECK-NEXT:    tail call void @fn2(ptr addrspace(200) noundef byval([[STRUCT_DWARF_ERROR]]) align 8 [[BYVAL_TEMP]]) #[[ATTR4]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p200(i64 4096, ptr addrspace(200) [[BYVAL_TEMP]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
void fn1() {
  fn2(a);
