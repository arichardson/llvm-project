...
// MIPS-NEXT:    [[TMP0:%.*]] = load i8, ptr @__sancov_gen_, align 1, !nosanitize [[META5:![0-9]+]]
// MIPS-NEXT:    [[TMP1:%.*]] = add i8 [[TMP0]], 1
// MIPS-NEXT:    store i8 [[TMP1]], ptr @__sancov_gen_, align 1, !nosanitize [[META5]]
...
// PURECAP-NEXT:    [[TMP0:%.*]] = load i8, ptr addrspace(200) @__sancov_gen_, align 1, !nosanitize [[META5:![0-9]+]]
...
// MIPS-NEXT:    [[TMP0:%.*]] = load i8, ptr @__sancov_gen_.2, align 1, !nosanitize [[META5]]
// MIPS-NEXT:    [[TMP1:%.*]] = add i8 [[TMP0]], 1
// MIPS-NEXT:    store i8 [[TMP1]], ptr @__sancov_gen_.2, align 1, !nosanitize [[META5]]
...
// PURECAP-NEXT:    [[TMP0:%.*]] = load i8, ptr addrspace(200) @__sancov_gen_.2, align 1, !nosanitize [[META5]]
// PURECAP-NEXT:    [[TMP1:%.*]] = add i8 [[TMP0]], 1
