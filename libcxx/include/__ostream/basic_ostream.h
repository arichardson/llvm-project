...
public:
  ...
  basic_ostream& operator<<(__intcap __n);
  basic_ostream& operator<<(unsigned __intcap __n);
#endif
...
#if __has_feature(capabilities)
template <class _CharT, class _Traits>
basic_ostream<_CharT, _Traits>& basic_ostream<_CharT, _Traits>::operator<<(__intcap __n) {
  return *this << static_cast<ptrdiff_t>(__n);
}

template <class _CharT, class _Traits>
basic_ostream<_CharT, _Traits>& basic_ostream<_CharT, _Traits>::operator<<(unsigned __intcap __n) {
  return *this << static_cast<ptraddr_t>(__n);
}
#endif
