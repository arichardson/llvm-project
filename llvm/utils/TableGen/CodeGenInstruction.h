...
template <typename T> class ArrayRef;
  ...
  public:
    ...
    struct OperandInfo {
      ...
      /// The instruction may trap if this operand is an untagged capability.
      bool TrapsIfUntaggedCapability = false;
  ...
  public:
    ...
    bool mayTrapOnUntaggedInput : 1;
    bool defMayBeSealed : 1;
    bool defIsAlwaysTagged : 1;
    bool isPredicable : 1;
