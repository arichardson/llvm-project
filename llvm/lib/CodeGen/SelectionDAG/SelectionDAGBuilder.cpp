...
void SelectionDAGBuilder::visitIntrinsicCall(const CallInst &I,
  ...
  case Intrinsic::memcpy: {
    ...
    SDValue MC = DAG.getMemcpy(
        ...
        MachinePointerInfo(I.getArgOperand(1)), MCI.getFrontendCopyType());
  ...
  case Intrinsic::memmove: {
    ...
    SDValue MM = DAG.getMemmove(
        ...
        MachinePointerInfo(I.getArgOperand(1)), MMI.getFrontendCopyType());
...
bool SelectionDAGBuilder::visitMemPCpyCall(const CallInst &I) {
  ...
  SDValue Root = isVol ? getRoot() : getMemoryRoot();
  SDValue MC = DAG.getMemcpy(
      Root, sdl, Dst, Src, Size, Alignment, isVol, false, /*isTailCall=*/false,
      shouldPreserveTags(&I), MachinePointerInfo(I.getArgOperand(0)),
