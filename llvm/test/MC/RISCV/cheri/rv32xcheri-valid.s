...
# STD-COMPAT-ERROR-NEXT: [[#@LINE+4]]:1: error: instruction requires the following: 'xcheri' extension with non-standard instructions, CHERI ISAv8 semantics (trapping, DDC/PCC relocation){{$}}
# STD-COMPAT-ERROR-NEXT: ctoptr x1, c2, c3
# STD-COMPAT-ERROR-NEXT: ^{{$}}
# CHECK: encoding: [0xdb,0x00,0x31,0x24]
ctoptr x1, c2, c3
# CHECK-INST: ctoptr ra, csp, ddc
# STD-COMPAT-ERROR-NEXT: [[#@LINE+4]]:1: error: instruction requires the following: 'xcheri' extension with non-standard instructions, CHERI ISAv8 semantics (trapping, DDC/PCC relocation){{$}}
# STD-COMPAT-ERROR-NEXT: ctoptr x1, c2, ddc
# STD-COMPAT-ERROR-NEXT: ^{{$}}
# CHECK: encoding: [0xdb,0x00,0x01,0x24]
ctoptr x1, c2, ddc
# CHECK-INST: cfromptr cra, csp, gp
# STD-COMPAT-ERROR-NEXT: [[#@LINE+4]]:1: error: instruction requires the following: 'xcheri' extension with non-standard instructions, CHERI ISAv8 semantics (trapping, DDC/PCC relocation){{$}}
# STD-COMPAT-ERROR-NEXT: cfromptr c1, c2, x3
# STD-COMPAT-ERROR-NEXT: ^{{$}}
# CHECK: encoding: [0xdb,0x00,0x31,0x26]
cfromptr c1, c2, x3
# CHECK-INST: cfromptr cra, ddc, gp
# STD-COMPAT-ERROR-NEXT: [[#@LINE+4]]:1: error: instruction requires the following: 'xcheri' extension with non-standard instructions, CHERI ISAv8 semantics (trapping, DDC/PCC relocation){{$}}
# STD-COMPAT-ERROR-NEXT: cfromptr c1, ddc, x3
# STD-COMPAT-ERROR-NEXT: ^{{$}}
