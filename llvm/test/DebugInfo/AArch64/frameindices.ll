...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr %1), !dbg !59
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr %1), !dbg !66
  ret void, !dbg !67
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr %1), !dbg !83
...
invoke.cont:                                      ; preds = %call.i.i.noexc
  call void @llvm.lifetime.end.p0(i64 24, ptr %1), !dbg !91
