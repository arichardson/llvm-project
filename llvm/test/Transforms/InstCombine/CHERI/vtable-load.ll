...
; RUN: sed -e 's/addrspace(200)/addrspace(0)/g' -e 's/-A200-P200-G200//g' %s | opt -S "-passes=instcombine" | FileCheck %s --check-prefix=HYBRID
; RUN: opt -S "-passes=instcombine" < %s | FileCheck %s --check-prefix=PURECAP
...
@_ZTV1A = internal unnamed_addr addrspace(200) constant { [4 x ptr addrspace(200)] } { [4 x ptr addrspace(200)] [ptr addrspace(200) null, ptr addrspace(200) @_ZTI1A, ptr addrspace(200) @member_function_1, ptr addrspace(200) @member_function_2] }, align 16
@_ZTI1A = external addrspace(200) constant { ptr addrspace(200), ptr addrspace(200) }, align 16

define ptr addrspace(200) @return_member_function_1() addrspace(200) {
; HYBRID-LABEL: define {{[^@]+}}@return_member_function_1() {
; HYBRID-NEXT:  call_member_fn_ptr.exit:
; HYBRID-NEXT:    ret ptr @member_function_1
;
...
declare i64 @member_function_1(ptr addrspace(200) nocapture nonnull readnone align 16 dereferenceable(16)) addrspace(200)
declare i64 @member_function_2(ptr addrspace(200) nocapture nonnull readnone align 16 dereferenceable(16)) addrspace(200)
