...
@char_ptr = external local_unnamed_addr addrspace(200) global ptr addrspace(200), align 32
...
declare void @test(ptr addrspace(200)) local_unnamed_addr addrspace(200) #0
