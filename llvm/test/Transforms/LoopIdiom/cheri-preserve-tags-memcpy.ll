...
; HYBRID-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[DST:%.*]], ptr align 4 [[UGLYGEP]], i64 [[TMP2]], i1 false) #[[ATTR2:[0-9]+]]
...
; HYBRID-NEXT:    [[TMP1:%.*]] = zext i32 [[COUNT]] to i64
; HYBRID-NEXT:    [[TMP2:%.*]] = shl nuw nsw i64 [[TMP1]], 4
; HYBRID-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[DST:%.*]], ptr align 4 [[UGLYGEP]], i64 [[TMP2]], i1 false) #[[ATTR3:[0-9]+]]
; HYBRID-NEXT:    br label [[BB30]]
; HYBRID:       bb30:
; HYBRID-NEXT:    ret void
;
