...
; RUN: opt --try-experimental-debuginfo-iterators < %s -S -passes=loop-vectorize -enable-vplan-native-path -force-vector-interleave=1 -force-vector-width=4 | FileCheck %s
